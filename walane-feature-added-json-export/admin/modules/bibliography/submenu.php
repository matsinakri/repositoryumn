...
$menu[] = array(__('Send Email Approved'), MWB.'bibliography/sendmail.php', __('Send Mail New ETD'));
...
$menu[] = array(__('Data Import'), MWB.'bibliography/import.php', __('Import Data to Bibliographic Database from CSV file'));
 $menu[] = array(__('XML Import'), MWB.'bibliography/import_xml.php', __('Import Item XML Format'));
