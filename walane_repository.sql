...
--
-- Host: localhost
-- Generation Time: Aug 30, 2023 at 01:34 PM
...
CREATE TABLE `biblio` (
  ...
  `code_ministry` varchar(50) DEFAULT NULL,
  ...
  `url_crossref` varchar(255) NOT NULL,
...
CREATE TABLE `biblio_custom` (
  `biblio_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='one to one relation with real biblio table';
...
CREATE TABLE `member_custom` (
  `member_id` varchar(20) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='one to one relation with real member table';
...
('13261', 'Administrasi Rumah Sakit', '5', 'Universitas Mohammad Natsir Bukittinggi', '2022-06-17', '2022-06-17'),
...
(1, 'library_name', 's:8:\"UMNatsir\";'),
(2, 'library_subname', 's:31:\"Repository UMNatsir Bukittinggi\";'),
...
(345, 'staff', 'admin', 'Login', 'Login success for user admin from address 127.0.0.1', '2022-06-17 04:17:49'),
(346, 'staff', '1', 'system', 'Admin change application global configuration', '2022-06-17 04:38:11'),
(347, 'staff', '1', 'system', 'Admin Log Out from application from address 127.0.0.1', '2022-06-17 05:38:59'),
(348, 'staff', 'admin', 'Login', 'Login success for user admin from address 127.0.0.1', '2022-06-17 05:50:12'),
(349, 'staff', '1', 'system', 'Admin DELETE content (Lisensi SLiMS)', '2022-06-17 05:51:09');
...
(1, 'admin', 'Admin', '$2y$10$JXkd/SqnJmZc8RW5DbQNBOOYnFxtCvKfqhyvcOpmP6WFu/.nt3ndm', '', 1, NULL, NULL, '2022-06-17 05:50:12', '127.0.0.1', 'a:1:{i:0;s:1:\"1\";}', '2017-08-16', '2020-07-26');
...
--
ALTER TABLE `setting`
  MODIFY `setting_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
